...
// ***************************
export const CONSENT_HISTORY_API_ENDPOINT_EXPORT_NAME = 'ConsentHistoryApiEndpoint';
export const CONSENT_MANAGEMENT_API_ENDPOINT_EXPORT_NAME = 'ConsentManagementApiEndpoint';

// WARNING: Do not change these export names without also updating the integ tests in .github/actions/.
...
export const CONSENT_HISTORY_API_GATEWAY_ID_EXPORT_NAME = 'ConsentHistoryApiGatewayId';
export const CONSENT_MANAGEMENT_API_GATEWAY_ID_EXPORT_NAME = 'ConsentManagementApiGatewayId';

// ***************************
// API Gateway properties
// ***************************
export const CONSENT_HISTORY_API_DOCS_URL = 'https://consent-management-platform.github.io/consent-history-api-models/v1/docs.html';
...
export const CONSENT_HISTORY_API_THROTTLING_LIMIT = 3;
export const CONSENT_HISTORY_API_THROTTLING_BURST_LIMIT = 5;
